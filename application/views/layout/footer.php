      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; RamonDevMoura - <?php echo date('Y') ?>&nbsp; | By Dev Ramon Moura </span>
          </div>
          &nbsp;
          <div class="copyright text-center my-auto">
         <span>Espero que você tenha gostado do projeto, caso tenha alguma dúvida me envio um email - ramonmoura2012@gmail.com</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
